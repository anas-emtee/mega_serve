...
$SQL_QUERY = "SELECT * FROM `sijila_cerfication_records`";
$SQL_LINK = "WHERE";
$FILTER_BY = "NONE";
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="mediumModalLabel">Upload Records By CSV</h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="upload_sijila" class="btn btn-primary">Confirm</button>
                        </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    <div class="row ">
                        <div class="col-lg-12  m-t-25">
                            <!-- DATA TABLE -->
                            <h3 class="title-5 m-b-35">Sijil A Records</h3>

                            <form action="batch_sijila.php" method="post">
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        ...
                                        <div class="rs-select2--light rs-select2--lg" style="min-width: 10vw !important;">
                                ...
                                <table class="table table-data2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="tr-shadow">
                                            ...
                                            <td>
                                                <div class="table-data-feature">
                                                    <a href="sijila_details.php?item_reference=<?= $ref ?>" class="item" data-toggle="tooltip" data-placement="top" title="More Details">
                                        ...
                                        <tr class="tr-shadow <?= $allow_act_class ?>">
                                            ...
                                            <td colspan="4">
                                                <button type="submit" name="batch_sijila_status" class="btn btn-primary btn-block">
